...
const Contact = () => {
  return (
    <div id="contact" className="pb-20 border-b border-gray-300">
        <motion.h1 
        ...
        <div className="tracking-tighter text-center">
            ...
            <a href="mailto:siriginidipavan@gmail.com" className="text-blue-500 no-underline hover:underline">
  siriginidipavan@gmail.com
</a>
